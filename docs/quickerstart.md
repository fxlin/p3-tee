...
Want to use own machines? We recommend granger1/2. Own Linux or Windows also works: package dependencies [instruction](https://optee.readthedocs.io/en/latest/building/prerequisites.html) and [WSL](wsl-ubuntu-howto.md).
