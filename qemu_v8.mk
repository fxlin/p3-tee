...
cleaner:  edk2-cleaner arm-tf-clean buildroot-cleaner linux-cleaner optee-os-clean \
	qemu-clean soc-term-clean check-clean
...
# FL: for cs4414
edk2-clean-config: 
	rm -f $(EDK2_PATH)/Conf/BuildEnv.sh

edk2-cleaner: edk2-clean-config edk2-clean
